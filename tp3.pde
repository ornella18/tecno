...
text(" en donde olfateaba olor a comida ",210,420);
  ...
  text("Presionar i para salir",60,220);
    ...
    textFont(texto2,20);
  text("clik aqui para seguir",80,230);
 ...
 textFont(texto2,25);
 fill(0);
 text("BARRA SPACIADORA para volver al inicio",250,500);
...
//cambiode estado:"casifinal"-->"final"
 ...
 void mousePressed(){
   ...
   if(mouseX > 60 && mouseX < 800 && mouseY > 130 && mouseY < 560 ){
   estado="historia y perro";
   
 }
 
 //cambio de estado:"lo ayuda"-->"patio"
   if(mouseX > 40 && mouseX < 800 && mouseY > 200 && mouseY < 560 ){
   estado="patio";
 }
  //cambio de estado:"hablar con el gato"-->"habitacion"
   if(mouseX > 500 && mouseX < 800 && mouseY > 150 && mouseY < 560 ){
   estado="habitacion";
 }
 }
